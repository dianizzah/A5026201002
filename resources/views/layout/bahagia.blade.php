...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="http://127.0.0.1:8000/kursi" class="w3-bar-item w3-button">[PRaktikum] Kursi</a>
        <a href="http://127.0.0.1:8000/nilaikuliah" class="w3-bar-item w3-button">[EAS] Nilai Kuliah</a>
